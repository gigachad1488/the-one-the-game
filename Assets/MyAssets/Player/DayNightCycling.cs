...
public class DayNightCycling : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Sequence.Create()
            .Group(Tween.Custom(1, 0, cycleTime * 0.1f, x => skyboxMaterial.SetFloat("_DayNightSlider", x), Ease.Linear))
            ...
            .Chain(Tween.Custom(0, 1, cycleTime * 0.2f, x => skyboxMaterial.SetFloat("_DayNightSlider", x), Ease.Linear))
            .Group(Tween.Custom(0.6f, 0.2f, cycleTime * 0.2f, x => globalLight.intensity = x, Ease.Linear))
